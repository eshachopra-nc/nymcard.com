...
const productItems: ProductItem[] = [
  ...
  },
  {
    ...
    label: 'Commercial Payments',
    description: 'Corporate spend and controls',
    href: '/products/commercial-payments',
    icon: Building2,
  },
  {
    kind: 'product',
  ...
  },
  {
    ...
    description: 'Fraud, AML, risk monitoring',
