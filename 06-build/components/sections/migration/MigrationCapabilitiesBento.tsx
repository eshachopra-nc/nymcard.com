...
const SURFACES: ReactNode[] = [
  <SchemaMappingPanel key="map" className="min-h-[17rem]" />,
  <ShadowProcessingView key="shadow" className="min-h-[16rem]" />,
  <BatchSequencingBoard key="seq" className="min-h-[16rem]" />,
  <MigrationControlConsole key="console" className="min-h-[17rem]" />,
];
