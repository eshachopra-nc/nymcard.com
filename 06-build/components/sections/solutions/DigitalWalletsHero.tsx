...
// ── Digital Wallets §1 — Hero ────────────────────────────────────────────────
//
// The shared, restrained product-page hero (the BaaSHero / NCoreHero pattern):
// a text-forward F-pattern with NO right-column UI — the story is told by the
...
//
// Copy mirrored VERBATIM from 02-copy/usecase-digital-wallets.md §Hero. No
// eyebrow — the headline leads (CLAUDE.md v1.5). One primary CTA + one
// secondary. Light (surface-soft).

const COPY = {
  headline: "Move, store, and spend money in one experience.",
  description:
    "Launch branded wallet experiences that help customers receive funds, store value, make payments, transfer money, and access financial services through a single digital experience.",
  primaryCta: { label: "Talk to us", href: "/company/contact" },
  secondaryCta: { label: "Explore nCore →", href: "/platform/ncore" },
} as const;

export function DigitalWalletsHero() {
