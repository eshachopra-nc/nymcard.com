...
export function RollbackDetail({ className }: { className?: string }) {
  return (
    <div className={cn(detailWrap, className)}>
      ...
      <p className="mt-2 font-mono text-[9.5px] uppercase tracking-[0.12em] text-text-muted dark:text-text-dark-muted">
...
function Side({
  ...
  return (
    ...
    >
      <p className="font-mono text-[8.5px] uppercase tracking-[0.12em] text-text-muted dark:text-text-dark-muted">
        {label}
      </p>
...
export function AuditTrailDetail({ className }: { className?: string }) {
  ...
  return (
    <div ref={ref} {...bind} className={cn(detailWrap, className)}>
      <ol className="relative space-y-1.5 pl-4">
        ...
        {TRAIL.map((row, i) => {
          ...
          return (
            ...
            >
              <span
                className="absolute -left-[14px] size-[7px] rounded-full ring-2 ring-surface-white dark:ring-surface-dark-elevated"
      ...
      <p className="mt-2 pl-4 font-mono text-[9.5px] uppercase tracking-[0.12em] text-text-muted dark:text-text-dark-muted">
