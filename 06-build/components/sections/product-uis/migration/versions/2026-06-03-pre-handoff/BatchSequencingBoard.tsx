              ...
              >
                ...
                <div className="flex min-w-0 flex-1 items-center justify-between gap-2 rounded-md border border-surface-border-subtle bg-surface-white/55 px-3 py-2 dark:border-surface-dark-border dark:bg-white/[0.04]">
                  <div className="min-w-0">
                    ...
                    <p className="truncate font-mono text-[9.5px] uppercase tracking-[0.08em] text-text-muted dark:text-text-dark-muted">
                      {b.meta}
                    </p>
                  </div>
                  {b.risk ? (
                    ...
                    <span className="font-mono text-[9.5px] uppercase tracking-[0.1em] text-text-muted dark:text-text-dark-muted">
                      queued
                    </span>
                  )}
                </div>
