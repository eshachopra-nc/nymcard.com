...
import { CardProgramsTabs } from "./CardProgramsTabs";
  ...
  return (
    <main>
      ...
      <PageHero
        ...
        // Card Issuing leads with a text-forward F-pattern hero; its visual
        // moment is the tabbed Card programs section below.
        // TODO: drive `textOnly` from Sanity once the field exists.
        textOnly={doc.slug === "card-issuing"}
      />
      ...
      {/* §3b Card programs — Card Issuing uses the interactive tabbed showcase
          (Debit / Prepaid / Credit → card + UI snippet + copy). Other pages
          render the capabilities bento.
          TODO: drive this choice from Sanity (e.g. capabilities.layout="tabs"). */}
